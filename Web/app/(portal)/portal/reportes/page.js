...
export default function ReportesPortal() {
  ...
  return (
    <>
            ...
            <div className="pt-bar-col" key={d.periodo}>
              <div className="pt-bar-track">
                <div
                  ...
                  title={metrica === "monto" ? pesos(d.monto) : `${d.volumen} ton`}
                />
              </div>
      ...
      {/* Tabla detalle */}
      {metrica === "monto" && datosReales && !datosReales.hayFacturacion && (
        <div
          className="pt-card"
          style={{ borderColor: "#f0895c", color: "#f0895c", fontSize: "0.88rem", marginBottom: "1rem" }}
        >
          La facturación todavía no está en el sistema, por eso los montos salen en cero.
          El <strong>peso</strong> sí es real: lo registra el chofer en cada servicio.
        </div>
      )}
            ...
            <tbody>
              {datos.map((d) => (
                <tr key={d.periodo}>
                  ...
                  <td className="num">{pesos(d.monto)}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
              <tr style={{ fontWeight: 700 }}>
                ...
                <td className="num">{pesos(totales.monto)}</td>
              </tr>
            </tfoot>
          </table>
        </div>
