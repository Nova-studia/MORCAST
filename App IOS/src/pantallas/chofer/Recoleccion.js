...
export default function Recoleccion({ route, navigation, completar }) {
  ...
  return (
    ...
    //
    // El keyboardVerticalOffset es SOLO para iOS y no sobra: esta pantalla
    // tiene encabezado de navegacion, y en iOS el "padding" se mide desde
    // arriba de la ventana, no desde abajo del encabezado. Sin restarle esa
    // altura, el campo del peso se queda tapado justo por lo que mide el
    // encabezado. En Android no aplica: ahi la ventana se redimensiona sola
